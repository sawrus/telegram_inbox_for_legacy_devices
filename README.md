...
Простой Flask-сервис для просмотра входящих сообщений из Telegram через MTProto. Проект рассчитан на запуск внутри домашней сети на Orange Pi Zero 2 с Ubuntu ARM и Docker Compose.

## Возможности

- выбор Telegram-чата из списка диалогов;
- просмотр только входящих сообщений выбранного чата;
- автообновление страницы через обычный HTML meta refresh;
- фронтенд без современного JavaScript, совместимый с iPad Safari iOS 12;
